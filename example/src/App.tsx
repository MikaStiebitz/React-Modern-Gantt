    ...
    <div className="app-container">
      ...
      <header className="app-header">
        ...
        <p className="app-subtitle">
          A flexible, customizable Gantt chart component for React applications with drag-and-drop task scheduling, dark
          mode support, progress tracking, and multiple view modes.
        </p>
      </header>
      ...
      <div id="section-basic" className="demo-section">
        ...
        <p className="demo-description">
          This example demonstrates the default Gantt chart with minimal configuration. You can drag tasks to reschedule
          them, resize them to change duration, and click on them to see details.
        </p>
      ...
      <div id="section-viewmodes" className="demo-section">
        ...
        <p className="demo-description">
          React Modern Gantt supports multiple timeline scales including Day, Week, Month, Quarter, and Year views.
          Toggle between different view modes to see how the chart adapts to different time frames.
        </p>
      ...
      <div id="section-infinite" className="demo-section">
        ...
        <p className="demo-description">
          Enable infinite scroll to automatically extend the timeline when dragging tasks beyond the visible range. This
          feature is perfect for dynamic project management where timelines need to adapt to changing schedules.
        </p>
      ...
      <div id="section-granular" className="demo-section">
        ...
        <p className="demo-description">
          Control exactly which editing features are enabled! Toggle between different permission combinations to allow
          or prevent task movement, resizing, and progress editing independently. Perfect for read-only views or
          restricted editing scenarios.
        </p>
      ...
      <div id="section-customized" className="demo-section">
        ...
        <p className="demo-description">
          This example showcases the powerful customization options available. Tasks have custom rendering based on
          their state (completed, dependent, selected), custom tooltips, and dynamic coloring. Click on a task to see it

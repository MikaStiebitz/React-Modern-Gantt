...
const Timeline: React.FC<TimelineProps> = React.memo(
    ({
        ...
        const getHigherLevelUnits = (): { date: Date; span: number }[] => {
            if (
                ![ViewMode.MINUTE, ViewMode.HOUR, ViewMode.DAY, ViewMode.WEEK].includes(viewMode) ||
                months.length === 0
            ) {
                return [];
            }
        ...
        const needsHierarchicalDisplay = [ViewMode.MINUTE, ViewMode.HOUR, ViewMode.DAY, ViewMode.WEEK].includes(
            viewMode,
        );
        ...
        return (
            <div
                ...
                {showTimelineHeader && needsHierarchicalDisplay && higherLevelUnits.length > 0 && (
